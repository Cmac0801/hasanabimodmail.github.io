# HasanAbi Modmail privacy policy

## Bot overview
HasanAbi Modmail is a ticketing system that lets users contact server staff through the bot instead of messaging staff members individually or pinging them publicly in the server.
...
To request access to your data or for your data to be deleted, please contact following user(s) on discord:
@cmac_
